...
export function page(query) {
  ...
  var leftTableName = 'gas_oil_type_mapbar'
  var rightTableName = 'aiso_gas_oil_type'
  var tableName = 'gas_oli_type_relation_mapbar_aiso'
  const data = {
    pageNum,
    pageSize,
    mapbarName,
...
export function pageAiso(query) {
  ...
  var tableName = 'aiso_gas_oil_type'
  const data = {
    pageNum,
    pageSize,
    cnInfo,
...
export function pageInstitute(query) {
  ...
  var pageSize = query.pageSize
  var cnInfo = query.cnInfo.trim()
  var tableName = 'gas_oil_type_mapbar'
  const data = {
    pageNum,
    pageSize,
    cnInfo,
