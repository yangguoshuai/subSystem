...
export function page(query) {
  ...
  var leftTableName = 'gas_service_mapbar'
  var rightTableName = 'aiso_gas_service'
  var tableName = 'gas_service_relation_mapbar_aiso'
  const data = {
    pageNum,
    pageSize,
    mapbarName,
...
export function pageAiso(query) {
  ...
  var tableName = 'aiso_gas_service'
  const data = {
    pageNum,
    pageSize,
    cnInfo,
...
export function pageInstitute(query) {
  ...
  var pageSize = query.pageSize
  var cnInfo = query.cnInfo.trim()
  var tableName = 'gas_service_mapbar'
  const data = {
    pageNum,
    pageSize,
    cnInfo,
