...
export function page(query) {
  ...
  var leftTableName = 'gas_fuel_type_mapbar'
  var rightTableName = 'aiso_gas_fuel_type'
  var tableName = 'gas_fuel_type_relation_mapbar_aiso'
  const data = {
    pageNum,
    pageSize,
    mapbarName,
...
export function pageAiso(query) {
  ...
  var tableName = 'aiso_gas_fuel_type'
  const data = {
    pageNum,
    pageSize,
    cnInfo,
