  ...
  data() {
    return {
      ...
      query: {
        ...
        autoInfo: null,
        version: null,
        relationTableName: 'gassp_aisoandauto_mapping',
        aisoTableName: 'aiso_gas_sp',
        autoTableName: 'auto_gas_sp',
        pageNum: 1,
        pageSize: 10
      },
      dataAddForm: {
  ...
  methods: {
    ...
    downloadData() {
      downloadData(this.query).then(response => {
        ...
        // 配置下载的文件名
        // this.curDateTime()
        link.download = this.dataAddForm.version + '_GasSP-Aiso-SW.csv'
    ...
    beforeUpload(file) {
      ...
      fd.append('file', file)
      fd.append('tableName', 'gassp_aisoandauto_mapping')
