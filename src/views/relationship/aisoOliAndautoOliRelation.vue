...
export default {
  ...
  data() {
    return {
      ...
      query: {
        ...
        autoInfo: null,
        version: null,
        relationTableName: 'gasoiltype_aisoandauto_mapping',
        aisoTableName: 'aiso_gas_oil_type',
        autoTableName: 'auto_gas_oil_type',
        pageNum: 1,
        pageSize: 10
      },
      dataAddForm: {
      ...
      aisoQuery: {
        ...
        list: null,
        total: null,
        tableName: 'aiso_gas_oil_type'
      },
      autoQuery: {
        autoGasBrandID: undefined,
        cnInfo: null,
        enInfo: null,
        version: null,
        pageNum: 1,
  ...
  methods: {
    version() {
      ...
      tab.append('tableName', 'gasoiltype_aisoandauto_mapping')
    ...
    downloadData() {
      downloadData(this.query).then(response => {
        ...
        // 配置下载的文件名
        // this.curDateTime()
        link.download = this.dataAddForm.version + '_GasOliType-Aiso-SW.csv'
    ...
    beforeUpload(file) {
      ...
      fd.append('file', file)
      fd.append('tableName', 'gasoiltype_aisoandauto_mapping')
