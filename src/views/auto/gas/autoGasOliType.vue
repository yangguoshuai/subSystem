<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      ...
      <el-col :span="4">
        <span>中文名称:</span>
        <el-input v-model="query.cnInfo" clearable style="width: 200px;" placeholder="模糊查询" @keyup.enter.native="handleAutoGasInfoAllQueryFilter" @input="handleAutoGasInfoAllQueryFilter" />
      </el-col>
      <el-col :span="6">
        <span>id:</span>
...
export default {
  ...
  methods: {
    version() {
      ...
      tab.append('tableName', 'auto_gas_oil_type')
    ...
    downloadData() {
      downloadData(this.query).then(response => {
        ...
        // 配置下载的文件名
        // this.curDateTime()
        link.download = this.dataAddForm.version + '_GasOliType-SW.csv'
    ...
    beforeUpload(file) {
      ...
      fd.append('file', file)
      fd.append('tableName', 'auto_gas_oil_type')
