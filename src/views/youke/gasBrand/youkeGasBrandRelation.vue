...
<script>
import { page, pageAiso, pageInstitute, addAisoInstituteData, delObj, downloadData, uploadFile } from '@/api/youke/gasbrand/youkeGasBrandRelation'
export default {
  ...
  methods: {
    ...
    downloadData(scheduleType) {
      downloadData().then(response => {
        ...
        link.download = 'youke_aiso_gas_brand_relation.csv'
        link.click()
      })
    },
    // 上传文件
