...
<script>
import { page, pageAiso, pageInstitute, addAisoInstituteData, delObj, downloadData, uploadFile } from '@/api/mapbar/gasOilType/gasOilTypeRelation'
export default {
  ...
  methods: {
    ...
    downloadData(scheduleType) {
      downloadData().then(response => {
        ...
        link.download = 'mapbar_aiso_gas_oil_type_relation.csv'
        link.click()
      })
    },
    // 上传文件
