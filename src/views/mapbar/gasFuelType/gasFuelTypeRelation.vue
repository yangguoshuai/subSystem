...
<script>
import { page, pageAiso, pageInstitute, addAisoInstituteData, delObj, downloadData, uploadFile } from '@/api/mapbar/gasFuelType/gasFuelTypeRelation'
export default {
  ...
  methods: {
    ...
    downloadData(scheduleType) {
      downloadData().then(response => {
        ...
        link.download = 'mapbar_aiso_gas_fuel_type_relation.csv'
        link.click()
      })
    },
    // 上传文件
