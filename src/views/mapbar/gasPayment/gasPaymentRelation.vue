...
<script>
import { page, pageAiso, pageInstitute, addAisoInstituteData, delObj, downloadData, uploadFile } from '@/api/mapbar/gasPayment/gasPaymentRelation'
export default {
  ...
  methods: {
    ...
    downloadData(scheduleType) {
      downloadData().then(response => {
        ...
        link.download = 'mapbar_aiso_gas_payment_relation.csv'
        link.click()
      })
    },
    // 上传文件
